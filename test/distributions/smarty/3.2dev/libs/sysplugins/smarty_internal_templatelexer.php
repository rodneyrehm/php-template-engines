...
//        $this->data = preg_replace("/(\r\n|\r|\n)/", "\n", $data);
    ...
    function yylex2()
    {
        ...
        $yy_global_pattern = "/\G(".$this->ldel."[$]smarty\\.block\\.child".$this->rdel.")|\G(\\{\\})|\G(".$this->ldel."\\*([\S\s]*?)\\*".$this->rdel.")|\G(".$this->ldel."strip".$this->rdel.")|\G(".$this->ldel."\\s{1,}strip\\s{1,}".$this->rdel.")|\G(".$this->ldel."\/strip".$this->rdel.")|\G(".$this->ldel."\\s{1,}\/strip\\s{1,}".$this->rdel.")|\G(".$this->ldel."\\s*literal\\s*".$this->rdel.")|\G((".$this->ldel."|\\s*".$this->ldel."--|[^\S\r\n]*".$this->ldel."-)\\s{1,}\/)|\G((".$this->ldel."|\\s*".$this->ldel."--|[^\S\r\n]*".$this->ldel."-)\\s*(if|elseif|else if|while)\\s+)|\G((".$this->ldel."|\\s*".$this->ldel."--|[^\S\r\n]*".$this->ldel."-)\\s*for\\s+)|\G((".$this->ldel."|\\s*".$this->ldel."--|[^\S\r\n]*".$this->ldel."-)\\s*foreach(?![^\s]))|\G((".$this->ldel."|\\s*".$this->ldel."--|[^\S\r\n]*".$this->ldel."-)\\s*setfilter\\s+)|\G((".$this->ldel."|\\s*".$this->ldel."--|[^\S\r\n]*".$this->ldel."-)\\s{1,})|\G((".$this->ldel."|\\s*".$this->ldel."--|[^\S\r\n]*".$this->ldel."-)\/)|\G((".$this->ldel."|\\s*".$this->ldel."--|[^\S\r\n]*".$this->ldel."-))|\G(<\\?(?:php\\w+|=|[a-zA-Z]+)?)|\G(\\?>)|\G(<%)|\G(%>)|\G([\S\s])/iS";
  ...
  $this->token = Smarty_Internal_Templateparser::TP_LITERAL;
    ...
    function yylex5()
    {
        ...
        $yy_global_pattern = "/\G((".$this->ldel."|\\s*".$this->ldel."--|[^\S\r\n]*".$this->ldel."-)\\s{1,}\/)|\G((".$this->ldel."|\\s*".$this->ldel."--|[^\S\r\n]*".$this->ldel."-)\\s*(if|elseif|else if|while)\\s+)|\G((".$this->ldel."|\\s*".$this->ldel."--|[^\S\r\n]*".$this->ldel."-)\\s*for\\s+)|\G((".$this->ldel."|\\s*".$this->ldel."--|[^\S\r\n]*".$this->ldel."-)\\s*foreach(?![^\s]))|\G((".$this->ldel."|\\s*".$this->ldel."--|[^\S\r\n]*".$this->ldel."-)\\s{1,})|\G((".$this->ldel."|\\s*".$this->ldel."--|[^\S\r\n]*".$this->ldel."-)\/)|\G((".$this->ldel."|\\s*".$this->ldel."--|[^\S\r\n]*".$this->ldel."-))|\G(\")|\G(`\\$)|\G(\\$[0-9]*[a-zA-Z_]\\w*)|\G(\\$)|\G(([^\"\\\\]*?)((?:\\\\.[^\"\\\\]*?)*?)(?=(".$this->ldel."|\\$|`\\$|\")))|\G([\S\s])/iS";
